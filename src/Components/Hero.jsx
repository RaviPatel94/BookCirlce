    ...
    <div className='h-screen w-screen'>
        <div className='relative flex items-center justify-center'>
            ...
            <div className='absolute text-white flex flex-col items-center gap-3'>
                <div className='grid3:text-8xl text-6xl drop-shadow-md font-Playfair'>BookCircle</div>
                <div className='grid3:text-4xl text-center text-2xl pb-2 drop-shadow-md'>Books Within Reach: Buy, Rent, Read, Repeat! </div>
