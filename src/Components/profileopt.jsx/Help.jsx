...
function Help() {
  ...
  return (
    <div id='help' className='flex flex-col gap-8 items-start w-10/12 md:w-9/12 pb-6 '>
      ...
      <div className='border hover:bg-gray-200 border-gray-300 shadow-md w-full py-3 flex flex-col items-start px-9 '>
      ...
      <div className='border hover:bg-gray-200 border-gray-300 shadow-md w-full  py-3 px-9 cursor-pointer '>Other</div>
      </div>
    </div>
  )
}
