        ...
        <table className='w-full table-fixed text-center border-separate border-spacing-y-2 font-normal'>
            ...
            <tbody >
                <tr className='border-b border-slate-700'>
                    ...
                    <td>450rs</td>
                    <td>29/12/2024</td>
                    <td><div className='flex items-center justify-center gap-2' > <div className='h-[10px] w-[10px] bg-red-500 rounded-full'></div>Processing</div></td>
                </tr>
                <tr>
                    <td>1654</td>
                ...
                <tr>
                    ...
                    <td>360rs</td>
                    <td>20/12/2024</td>
                    <td><div className='flex items-center justify-center gap-2' > <div className='h-[10px] w-[10px] bg-green-500 rounded-full'></div>Delivered</div></td>
                </tr>
                <tr>
                    <td>2349</td>
